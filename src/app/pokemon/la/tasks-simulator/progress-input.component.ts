...
@Component({
  ...
  template: `
    ...
    <div
      class="bg-secondary/20 focus-within:outline-blue flex items-center justify-center rounded-lg shadow-sm focus-within:outline-1">
      <input
        type="number"
